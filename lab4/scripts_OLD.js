...
window.onload = function ()                                        // wait till html page loaded
{
	...
	{
		pieces[piece].onmouseover = function ()                    // bind the same Event to each element
		{
		...
		pieces[piece].onclick = function ()                         // bind this same Event to each element
		{
			...
			if(pieceClass == "piece-x")                             // continue to toggle through the classes
			{
				this.className = "piece-o";
			}
			
			if(pieceClass == "piece-o")
			{
